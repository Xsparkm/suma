...
TOKEN = "ODQ4NjAxNzg1NzAxNDk4OTEw.GTaYzy.Sqql6gXmyRVQvrfTdorRkurZf39SfcgzeUkiG0"
...
async def on_message(message):
    ...
    if message.channel.id == 1255593067436834817:  # Replace with your channel ID
        knowledge_base = await loadFile("tsundere/tsundere.json")
